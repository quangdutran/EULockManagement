...
public interface StayRepository extends JpaRepository<Stay, Long> {
  ...
  @Query(
      "SELECT s from Stay s WHERE s.checkInTime BETWEEN :fromTime AND :toTime AND s.actualCheckoutTime IS NOT NULL")
  ...
  @Query(
      value =
          "SELECT EXTRACT(YEAR FROM s.check_in_time) AS year, "
