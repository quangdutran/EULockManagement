...
public class LockService {
    ...
    public List<LockDTO> getLocks(int pageSize, int pageNumber) {
        ...
        EUAPIResponseParser<LockListResponse> parser = new EUAPIResponseParser<>(LockListResponse.class);
        ...
        return lockListResponse.getData().map(lockList -> lockList.getList()
                    .stream().map(l -> LockDTO.builder().lockId(String.valueOf(l.getLockId()))
                        .lockAlias(l.getLockAlias()).electricQuantity(l.getElectricQuantity()).build())
    ...
    public String getOpenCode(String lockId) {
        ...
        EUAPIResponseParser<PassCodeResponse> parser = new EUAPIResponseParser<>(PassCodeResponse.class);
