...
public class AccessTokenService {
  ...
  private RefreshTokenResponse getNewAccessToken() {
    ...
    EUAPIResponseParser<NewTokenResponse> parser =
        new EUAPIResponseParser<>(NewTokenResponse.class);
  ...
  private RefreshTokenResponse refresh() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(url, HttpMethod.POST, requestEntity, String.class);
    EUAPIResponseParser<RefreshTokenResponse> parser =
        new EUAPIResponseParser<>(RefreshTokenResponse.class);
