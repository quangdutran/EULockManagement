...
import com.dutq.lock.management.lock_management.mappers.UserMapper;
import com.dutq.lock.management.lock_management.repositories.UserRepository;
...
public class UserService {
  ...
  public UserDto login(CredentialsDto credentialsDto) {
    User user =
        userRepository
            .findByLogin(credentialsDto.getLogin())
